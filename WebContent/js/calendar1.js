...
// Funçao utilizada para a fotmataçao da Data no formato dd/mm/yyyy
// Funçao deve ser chamada no onblur dos campos
function formataData(campo, descricao){
  ...
  if(valor.length>0 && valor.length < 8){
      alert('Campo '+descricao+' inválido.');
      campo.focus();
      return;
  }else{
  ...
  validaFormatoData(retorno,campo);
 	campo.value = retorno;
}
