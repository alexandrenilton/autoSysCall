...
**********************************************************************************************/
  ...
  this.item_width1 = 120  
  this.item_width2 = 120 
...
**********************************************************************************************/
  ...
  this.url0_0 = system_path+"/mantemUsuario.do?acao=parametrosConsultarUsuario"
	
  this.item0_1 = "Cadastrar Usuário"
  this.url0_1 = system_path+"/mantemUsuario.do?acao=parametrosCadastrarUsuario"
  
  this.item0_2 = "Consultar Vários Usuários"
  this.url0_2 = system_path+"/mantemUsuario.do?acao=parametrosConsultarVariosUsuarios"
  
  this.item0_3 = "Excluir Usuário"
  this.url0_3 = system_path+"/mantemUsuario.do?acao=parametrosExcluirUsuario"
   
  this.item0_4 = "Cancelar Usuário"
  this.url0_4 = system_path+"/mantemUsuario.do?acao=parametrosCancelarUsuario"
