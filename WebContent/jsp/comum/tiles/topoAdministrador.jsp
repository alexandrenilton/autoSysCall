<%
	...
	String perfil = (String) "Atendente";
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr><td bgcolor="#4791c5"><font color="#FFFFFF" size="2" face="Tahoma, Verdana"> </font></td>
     	<td width="100%" bgcolor="#4791c5"><font color="#FFFFFF" size="2" face="Tahoma, Verdana">Usuário: <%=session.getAttribute("TR")%> - <%=session.getAttribute("NOME")%>  </font></td>
  </tr>
</table>
