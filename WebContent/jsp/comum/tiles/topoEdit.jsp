...
<%
	String chave = (String) session.getAttribute("CHAVE_HUR");
	String nome = (String) session.getAttribute("NOME_HUR");
	String perfil = (String) session.getAttribute("PERFIL_HUR");
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	<TBODY>
		<TR>
			<TD rowSpan=2 noWrap background="img/tab.bg.dln.new.gif">
				&nbsp;
				<img src="img/logo.brt2.new.gif" width="123" height="60" align="top">
			</TD>
			<TD rowSpan=2 noWrap background="img/tab.bg.dln.new.gif">
				<img src="img/tab.slide.hm.li.new.gif" width="109" height="90">
			</TD>
			<TD width="100%" height=55 colSpan=12 align="right" valign="middle" bgColor=#336699>
				<img src="img/logo_HUR.gif" width="500" height="50" align="middle">
			</TD>
		</TR>
		<TR>
			<TD noWrap background="img/tab.bg.on.gif">
				<img src="img/tab.separator.off.gif">
			</TD>
			<TD noWrap background="img/tab.bg.on.gif">
			...
			<TD noWrap background="img/tab.bg.off.gif">
				<img src="img/tab.separator.on.r.gif">
			</TD>
			<!--<TD noWrap background="img/fundoDescamarcado.png">-->
			<td noWrap background="img/tab.bg.off.gif">
				<strong>
				<a href="javascript:encerra();"><font face="Tahoma" size="2" color="#FFFFFF">&nbsp;&nbsp;&nbsp;Sair&nbsp;&nbsp;&nbsp;</font>
				</a>
				</strong>
			</TD>
			<TD noWrap background="img/tab.bg.off.gif">
				<img src="img/separadorFinal.gif">
			</TD>
			<TD width="100%" align="right" valign="middle" background="img/tab.bg.sln.gif">
				<font color="#FFFFFF" size="2" face="Tahoma, Verdana"></font>
				<font color="#FFFFFF" size="2" face="Tahoma, Verdana"><%=strData%>&nbsp;</font>
			</TD>
		</TR>
	</TBODY>
</TABLE>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td width="100%" bgcolor="#4791c5">
			<font color="#FFFFFF" size="2" face="Tahoma, Verdana">Usuário: <%=chave%> - <%=nome%> </font>
		</td>
	</tr>
</table>
...
<table width="100%" height="25" background="img/fundo_barra2.gif" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
			<script language="JavaScript" vqptag="doc_level_settings" is_vqp_html=1 vqp_datafile0="js/header.js" vqp_uid0=121086>
      cdd__codebase = "js/";
      ...
      var system_path = "<%=url_final%>";
		...
		<script language="JavaScript" src="js/pbrowser_ie.js"></script>
