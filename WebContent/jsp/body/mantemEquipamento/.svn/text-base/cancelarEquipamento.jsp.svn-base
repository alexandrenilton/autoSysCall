...
<input type="hidden" name="acao" value="buscar" />
	...
	<tr>
		<td>
			<fieldset style="border-left: 1px solid #336699;border-right: 1px solid #336699;border-top: 1px solid #336699;border-bottom: 1px solid #336699"><legend class="labelForm"><font color="#336699">Cancelar Equipamento</font></legend>
			<table align="center">
				<tr>
					<td>
						<br><br>
