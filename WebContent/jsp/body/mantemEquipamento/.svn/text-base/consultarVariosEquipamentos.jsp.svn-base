...
<input type="hidden" name="acao" value="consultarVariosUsuarios" />
	...
	<tr>
		<td>
			<fieldset style="border-left: 1px solid #336699;border-right: 1px solid #336699;border-top: 1px solid #336699;border-bottom: 1px solid #336699"><legend class="labelForm"><font color="#336699">Consultar Vários Equipamentos</font></legend>
			<table align="center">
				<tr>
					<td>
						<br><br>
					...
					<tr>
						...
						<td valing="buttom">
						   <input text size="30" >
						   <!-- 
						   <html:text name="usuarioForm" styleClass="objFormText" property="usuarioDto.empresa" size="30"  title="Nome"/>
							-->
						</td>
					</tr>
