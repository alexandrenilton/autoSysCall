...
<script language="JavaScript">
  ...
  var arrayCampos = new Array("usuarioDto.userId");
  ...
  function excluir(){
  	  	document.forms[0].action="<%=request.getContextPath()%>/mantemUsuario.do?acao=excluirUsuario" ;
...
<html:hidden property="acao" value="excluirUsuario" name="usuarioForm" />
	<table width="50%" align="center">
	<tr>
		<td>
			<fieldset style="border-left: 1px solid #336699;border-right: 1px solid #336699;border-top: 1px solid #336699;border-bottom: 1px solid #336699"><legend class="labelForm"><font color="#336699">Excluir Usu&aacute;rio</font></legend>
			<table align="center">
				<tr>
					<td>
						<br><br>
				...
				<tr>
						...
						<td valing="buttom">
						   <html:text name="usuarioForm" styleClass="objFormText" property="usuarioDto.userId" size="15"  title="UserId"/>
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" align="center">
							<input name="Excluir" type="submit"  value="Excluir" class="btn">
