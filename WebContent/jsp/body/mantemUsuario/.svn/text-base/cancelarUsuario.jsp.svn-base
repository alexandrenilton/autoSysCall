...
<script language="JavaScript">
  ...
  var arrayCampos = new Array("usuarioDto.userId");
	...
	function hur(){
  	...
  	function cancelar(){
  	  	document.forms[0].action="<%=request.getContextPath()%>/mantemUsuario.do?acao=cancelarUsuario" ;
...
<input type="hidden" name="acao" value="cancelar" />
	...
	<tr>
		<td>
			<fieldset style="border-left: 1px solid #336699;border-right: 1px solid #336699;border-top: 1px solid #336699;border-bottom: 1px solid #336699"><legend class="labelForm"><font color="#336699">Cancelar Usu&aacute;rio</font></legend>
			<table align="center">
				<tr>
					<td>
						<br><br>
				...
				<tr>
					...
					<tr>
						<td colspan="2" align="center">
							<input name="Cancelar"  type="submit"  value="Cancelar" class="btn" onClick="JavaScript:cancelar()">
