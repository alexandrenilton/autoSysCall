...
<script language="JavaScript">
	...
	function cadastrar(){
	   ...
	   if(flag){
			document.forms[0].action="<%=request.getContextPath()%>/cadastrarProcessoAutomatizado.do?acao=geracaoHur" ;
	   	document.forms[0].submit();
	   }
  	}
	
	function consultar(){
		document.forms[0].action="<%=request.getContextPath()%>/consultarProcessoAutomatizado.do?acao=geracaoHur" ;
		document.forms[0].submit();
	}
...
<table width="50%" align="center">
	...
	<tr>
		<td>
			<fieldset style="border-left: 1px solid #336699;border-right: 1px solid #336699;border-top: 1px solid #336699;border-bottom: 1px solid #336699"><legend class="labelForm"><font color="#336699">Processo Automatizado - Geracao de HUR</font></legend>
			<table align="center">
					<tr>
