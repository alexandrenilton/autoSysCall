...
<script language="JavaScript">
   ...
   var arrayCampos = new Array("chamadoDto.userId");
...
<tr>
  <table width="100%" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr>
        ...
        <td width="100%" background="img/brt.tab.top.middle.ex.gif"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><img src="img/xp.folder.open.gif" width="16" height="14" align="top">&nbsp;Abrir Chamados</font></strong></td>
...
<input type="hidden" name="acao" value="abrirchamadouser" />
	<table width="50%" align="center">
	<tr>
		<td>
			<fieldset style="border-left: 1px solid #336699;border-right: 1px solid #336699;border-top: 1px solid #336699;border-bottom: 1px solid #336699"><legend class="labelForm"><font color="#336699">Abrir Chamado</font></legend>
			<table align="center">
				<tr>
					<td>
						<br><br>
				...
				<tr>
					<td colspan="2" align="center">
						<input name="Pesquisar" type="submit" value="Seguir" class="btn">
						<input name="Limpar"    type="reset"  value="Limpar" onClick="JavaScript:limpar()" class="btn" >
						<input name="Sair"      type="button" onClick="JavaScript:principal();" value="Sair" class="btn">
						<br><br>
					</td>
				</tr>
				</table>
